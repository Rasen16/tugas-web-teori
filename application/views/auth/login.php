					...
					<div class="col">
						<div class="p-5">
							<div class="text-center">
								<h1 class="h4 text-gray-900 mb-4">Selamat Datang, Silahkan Login Untuk Absensi</h1>
                               <img src="<?= base_url('image/rs.png') ?>" class="img-thumbnail rounded-circle" style="height:100px; width:100px"> 
							</div>
